...
def validate_mini_app_init_data(init_data_raw: str, bot_token: str) -> dict | None:
    ...
    Возвращает словарь полей (без hash) или None при невалидных данных
    или просроченных данных (auth_date старше 3600 секунд).
    Поле user возвращается как словарь (распарсенный из JSON).
    """
